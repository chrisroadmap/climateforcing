...
def calc_aprp(base, pert, lw=False, breakdown=False, globalmean=False, lat=None):
    ...
    reverse = {}
    central = {}
    forward['t1'] = -base['rsdt']*(1-clt)*dAcs_daclr
    forward['t2'] = -base['rsdt']*(1-clt)*dAcs_dgaer
    forward['t3'] = -base['rsdt']*(1-clt)*dAcs_dmaer
    forward['t4'] = -base['rsdt']*clt*(dAoc_dacld)
    forward['t5'] = -base['rsdt']*clt*(dAoc_dgaer)
    forward['t6'] = -base['rsdt']*clt*(dAoc_dmaer)
    forward['t7'] = -base['rsdt']*clt*(dAoc_dgcld)
    forward['t8'] = -base['rsdt']*clt*(dAoc_dmcld)
    ...
    reverse['t1'] = -pert['rsdt']*(1-clt)*dAcs_daclr
    reverse['t2'] = -pert['rsdt']*(1-clt)*dAcs_dgaer
    reverse['t3'] = -pert['rsdt']*(1-clt)*dAcs_dmaer
    reverse['t4'] = -pert['rsdt']*clt*(dAoc_dacld)
    reverse['t5'] = -pert['rsdt']*clt*(dAoc_dgaer)
    reverse['t6'] = -pert['rsdt']*clt*(dAoc_dmaer)
    reverse['t7'] = -pert['rsdt']*clt*(dAoc_dgcld)
    reverse['t8'] = -pert['rsdt']*clt*(dAoc_dmcld)
